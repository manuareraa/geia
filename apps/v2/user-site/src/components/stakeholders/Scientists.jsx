  ...
  return (
    <div className="flex flex-col items-center justify-center w-full p-8 bg-[#F9FAF6] lg:p-20">
      ...
      <p className="text-[25px] md:text-[35px] lg:text-[45px] text-center lg:w-[1000px] md:w-[85%] w-[100%] font-bold">
        Follow the <span className=" text-gGreen">Science</span>
      </p>
      ...
      <div className="grid items-center justify-center grid-cols-1 py-8 space-y-8 lg:grid-cols-2 lg:flex-row lg:space-x-8 lg:space-y-0">
        <p className="py-12 text-2xl font-medium text-center">
          ...
          companies that are dedicated to a regenerative future, using the
          latest in geospatial and on the ground analysis. This coupled with
          Geoblocs NFTs creates a transparent and verifiable system for
      ...
      <p className="font-medium lg:w-[800px] w-[100%] md:w-[85%] text-center text-2xl py-12">
        GEIA, through its platform <span className="text-gGreen">Geoblocs</span>
        , is bringing together specialists from a wide variety of disciplines
        and backgrounds. From satellite monitoring platforms, to university
        departments dedicated to the observation and restoration of
        biodiversity.
      </p>
      <p className="font-medium lg:w-[800px] w-[100%] md:w-[85%] text-center text-2xl py-12">
